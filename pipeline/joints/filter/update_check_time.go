...
const decelerateSteps pipeline.ParaKey = "decelerate_steps"
const accelerateSteps pipeline.ParaKey = "accelerate_steps"
...
func updateNextCheckTime(c *pipeline.Context, current time.Time, steps []int, changed bool) {
